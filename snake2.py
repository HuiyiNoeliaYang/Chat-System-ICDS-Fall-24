...
def run_game(score,in_game):
    ...
    def next_turn(snake, food):
        ...
        if x == food.coordinates[0] and y == food.coordinates[1]:
            score[0]+= 1
            label.config(text="Points:{}".format(score[0]))
            canvas.delete("food")
            food = Food()
        else:
    ...
    # Display score label
    label = Label(window, text="Points:{}".format(score[0]), font=('consolas', 20))
    label.pack()
    ...
    # window.mainloop()
    # return in_game
# print(run_game(score=[0],in_game=[True]))
# Run the game
